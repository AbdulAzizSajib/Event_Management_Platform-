...
const startConversation = async (userId, eventId) => {
    ...
    if (event.organizerId === userId) {
        throw new AppError(status.BAD_REQUEST, "You cannot start a conversation for your own event");
    }
...
const getMessages = async (conversationId, userId, query) => {
    ...
    if (conversation.userId !== userId && conversation.organizerId !== userId) {
        throw new AppError(status.FORBIDDEN, "You are not a participant of this conversation");
    }
